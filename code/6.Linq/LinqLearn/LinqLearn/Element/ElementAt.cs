...
namespace LinqLearn.Element
{
    public class ElementAt
    {
        ...
        {
            Student student1 = _students.ElementAt(2);
            Console.WriteLine($"Id: {student1.Id}, Name: {student1.Name}, Age: {student1.Age}");
            // If element not exist on particular index then it will throws an exception.

            Student student2 = _students.ElementAtOrDefault(2);
            Console.WriteLine($"Id: {student2.Id}, Name: {student2.Name}, Age: {student2.Age}");
            // If element not exist on particular index then it will return null.
        }
    }
}
